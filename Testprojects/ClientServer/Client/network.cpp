#include "RPC/generic_include/RPC_types.h"
#include <vector>
#include <fstream>
#include <cassert>
#include <mutex>
...
extern "C" {
	...
	RPC_RESULT RPC_UART_message_commit(void){
