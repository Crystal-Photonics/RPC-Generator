...
parser.add_argument("inputheader", help = "Source header file with function declarations which are to be made available on another device", type = str)
parser.add_argument("outputheader", help = "Destination header file with function declarations which have been made available for another device", type = str)
parser.add_argument("outputcimplementation", help = "Destination c file with function implementations which have been made available for another device", type = str)
args = parser.parse_args()

inputfile = args.inputheader
